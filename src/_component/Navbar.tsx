    ...
    <nav className="sticky top-0 z-50 bg-spa-cream/95 backdrop-blur-md border-b border-spa-gold/20 shadow-sm transition-all duration-300">
      <div className="container mx-auto px-4 py-3">
        ...
        <div className="flex justify-between items-center relative">
          ...
          {/* LEFT: Fixed width using new standard class w-25 (100px) */}
          ...
          {/* CENTER: Updated 'flex-grow' to 'grow' */}
          <div className="text-center md:absolute md:left-1/2 md:-translate-x-1/2 grow md:grow-0">
            <a href="/" className="group block no-underline">
              <h1 className="text-2xl md:text-3xl font-display font-bold text-spa-brown tracking-tighter group-hover:text-spa-gold transition-colors duration-300">
                PREMIER
              </h1>
          ...
          {/* RIGHT: Fixed width using new standard class w-25 */}
